...
(function () {
    var PATHS = {
        ...
        // Not: _icons.html'de var ama önceden burada YOKTU (denetimde çıkan
        // drift) — hiçbir JS dosyası şu an ICONS.get('home'/'log-out')
        // çağırmıyor (ikisi de sadece base.html navbar'ında Jinja makrosuyla
        // render ediliyor), ama iki dosyanın senkron kalması gerektiği
        // (dosya başındaki yorum) net olduğu için eklendi.
